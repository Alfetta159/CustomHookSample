...
function App() {
  ...
  // and alertState object which is what our Alert will look like.
  const {
    setAlert,
    alertState,
  } = useProcessAlert(true,
    'info',
  ...
  // Here we return the HTML setting the one alertState property of our ProcessAlert to the alertState object 
  ...
  return (
    <Container>
      ...
      <Row>
        <Col>
          <ProcessAlert alertState={alertState} />
        </Col>
      </Row>
      <Row>
